...
if app_mode == "Home":
    ...
    ### Note
    This model is made for project purposes and has no affiliation with any organization or company. The model is trained on a custom dataset and may not be suitable for commercial use.
    ### Dataset Credits 
...
# Prediction Page
    ...
    if st.button("Predict"):
        ...
        st.success("Model has Predicted it's a {}".format(
